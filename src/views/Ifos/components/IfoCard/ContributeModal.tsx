...
import { Modal, LinkExternal, Box, Text } from '@passive-income/dpex-uikit'
  ...
  return (
    <Modal title={`Contribute ${currency}`} onDismiss={onDismiss}>
      <Box maxWidth="400px">
        ...
        />
        <LinkExternal
          href={`${process.env.REACT_APP_PSIDEX_URL}/#/add/BNB/0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82`}
