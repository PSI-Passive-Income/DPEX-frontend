    ...
    <div>
      ...
      <LaunchIfoCallout>
        <div>
          ...
          <Flex mb="16px">
            <LinkExternal href={`${process.env.REACT_APP_PSIDEX_URL}`} mr="16px">
              {TranslateString(1060, 'Buy CAKE')}
            </LinkExternal>
            <LinkExternal href={`${process.env.REACT_APP_PSIDEX_URL}/#/add/BNB/0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82`}>
