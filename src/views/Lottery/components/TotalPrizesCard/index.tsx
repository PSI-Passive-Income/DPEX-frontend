...
import { Heading, Card, CardBody, CardFooter, Text, PSIRoundIcon, Flex, Skeleton } from '@passive-income/dpex-uikit'
...
const TotalPrizesCard = () => {
  ...
  const lotteryPrizeAmountBusd = new BigNumber(lotteryPrizeAmount).multipliedBy(usePriceIncomeBusd()).toNumber()
